...
import br.dev.garage474.mspedido.models.OrderItem;
...
/**
 * DTO para transferência de dados de um item do pedido.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class OrderItemDto {
    ...
    public static List<OrderItemDto> mapOrderItemsToDto(List<OrderItem> items) {
        return items.stream()
