...
import br.dev.garage474.mscatalog.adapter.out.persistence.entity.ProductVariantEntity;
...
import br.dev.garage474.mscatalog.domain.entity.ProductVariant;
...
public class JpaProductRepository implements ProductRepository {
    ...
    private br.dev.garage474.mscatalog.domain.entity.Brand convertBrandToEntity(
            br.dev.garage474.mscatalog.adapter.out.persistence.entity.BrandEntity entity) {
        br.dev.garage474.mscatalog.domain.entity.Brand brand = new br.dev.garage474.mscatalog.domain.entity.Brand();
        brand.setId(entity.getId());
        brand.setName(entity.getName());
        return brand;
    }

    private br.dev.garage474.mscatalog.domain.entity.Category convertCategoryToEntity(
            br.dev.garage474.mscatalog.adapter.out.persistence.entity.CategoryEntity entity) {
        br.dev.garage474.mscatalog.domain.entity.Category category = new br.dev.garage474.mscatalog.domain.entity.Category();
